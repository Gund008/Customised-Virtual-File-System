...
#define MAXINODE 50  //Preprocessor Replaced in Macro
...
PINODE head=NULL;     //(struct node *inode)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Used Commands and System call used
...
PINODE Get_Inode(char *name)   //(struct node *inode)
{
    PINODE temp=head;
    int i=0;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Create linked list of(Disk Inode list block)
...
void CreateDILB()               //Insert First
{
    ...
    while(i <= MAXINODE)
    {
        newn=(PINODE)malloc(sizeof(INODE));    //newn=(struct *inode INODE)malloc(sizeof(INODE)) 194 Typecasting
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//hard disk madlya file chi Information
...
int CreateFile(char *name,int permission)   //(fname[],0777)
{
    ...
    UFDTArr[i].ptrfiletable=(PFILETABLE)malloc(sizeof(FILETABLE));  //Memory Allocation Of FILETABLE

    UFDTArr[i].ptrfiletable->count=1;   //Member Intialised File Table
    ...
    UFDTArr[i].ptrfiletable->ptrinode->FileType=REGULAR;    //Member intilised INODE(Metadata of File)
...
int  rm_file(char *name)  
{
    ...
    fd=GetFDFromName(name);  //functional call
...
##  Input           :   int,char*,int
##	Output			: 	int
##	Description 	: 	To Read the contents from file
##	Author			: 	Sukanya Gund
##	Date			:   26 Jan 2023
...
int WriteFile(int fd,char *arr,int isize)   //write(int fd,char arr[],int isize)
{
    ...
    if((UFDTArr[fd].ptrfiletable->writeoffset)==MAXFILESIZE)  //0==2048
    {
       return -2;
    }
...
int OpenFile(char *name,int mode)  //Syntax(char fname[],int mode)
{
    int i=0;
    PINODE temp=NULL;

    if(name==NULL || mode <= 0)        //Filter
    {
        return -1;
    }

    temp=Get_Inode(name);           //Functional call
    ...
    UFDTArr[i].ptrfiletable=(PFILETABLE)malloc(sizeof(FILETABLE));  //question v4
...
int CloseFileByName(char *name)   //(char *fname)
{
    ...
    i=GetFDFromName(name);   //functional call
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Display  All Information of file
#########################################################################################
##  Function Name	:   fstat
##  Input           :   int
##	Output			: 	int
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Display All Information of file(inode)
...
{
    int fd=GetFDFromName(name);  //Function call
...
int main()
{
    ...
    char command[4][80],str[80],arr[1024];  //file restriction 1KB.

    InitialiseSuperBlock();   //Akdach call hotil
    CreateDILB();
    ...
    while(1)                            //Infinite Hearing Loop 
    {
          ...
          count=sscanf(str,"%s %s %s %s",command[0],command[1],command[2],command[3]);  //toknization of String  tukde
          ...
          if(count==1)
           {
            ...
            else if(count==2)
            {
                ...
                {
                    fd=GetFDFromName(command[1]);    //functional call()
